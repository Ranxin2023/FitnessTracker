...
function submit_past_activity_onclick() {
  ...
  /* get id from /name */
  // let nameData = document.getElementById("username").textContent;
  // let name = nameData.slice(0,-1);
  let idNum;
  let myFetch=fetch(`/name`, {
    method: 'GET',
    headers: {
...
// let logout_option = document.getElementById("logOut");
// logout_option.addEventListener("click", signOut());
// function signOut() {
